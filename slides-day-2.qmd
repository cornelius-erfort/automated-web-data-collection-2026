...
Additional example (dynamic member table): <https://sansad.in/ls/members>
...
-   **Time:** 25-30 minutes
-   **Where in GitHub:** [`exercises/05-httr.R`](exercises/05-httr.R)
-   **Goal:** reproduce a browser request with `httr`, inspect the response, and parse the returned content
-   **Steps:**
    1.  Open [`exercises/05-httr.R`](exercises/05-httr.R)
...
-   **Time:** 20-25 minutes
-   **Where in GitHub:** [`exercises/06-helpful-tools.R`](exercises/06-helpful-tools.R)
-   **Goal:** make your scraper more reliable (progress, caching, logging, error handling)
-   **Steps:**
    1.  Open [`exercises/06-helpful-tools.R`](exercises/06-helpful-tools.R)
...
::: {.small-font}
-   **Time:** 45-60 minutes
-   **Where in GitHub:** [`exercises/07-hands-on-project.R`](exercises/07-hands-on-project.R)
