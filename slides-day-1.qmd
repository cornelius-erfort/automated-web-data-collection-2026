...
-   Experience with **web scraping**?
    -   If yes: what did you scrape (site/API), and with what tools (e.g. `rvest`, `chromote`/`read_html_live()`, `httr`)?
...
-   Recommended: clone the repo (`git clone ...`) so updates are easy to pull.
-   Alternative: download the ZIP and save it in a folder for this workshop.
...
::: {.column width="30%"}
![](slides/images/munzert.jpg){width="80%"}
:::
:::::
...
::: {.column width="30%"}
![](slides/images/wickham.jpg){width="80%"}
:::
:::::
...
-   Open in browser: [HTML example (plain)](slides/examples/html-syntax-plain.html)
...
-   Open in browser: [HTML example (styled)](slides/examples/html-syntax-styled.html)
...
[Abgeordnete (Berliner Parlament)](https://www.parlament-berlin.de/das-parlament/abgeordnete/alphabetische-suche)

```{r bundestag}
qr_code("https://www.parlament-berlin.de/das-parlament/abgeordnete/alphabetische-suche") %>% plot
```
...
[Political scientists on Wikipedia](https://en.wikipedia.org/wiki/List_of_political_scientists)
...
-   [Abgeordnete (Berliner Parlament)](https://www.parlament-berlin.de/das-parlament/abgeordnete/alphabetische-suche) → `.has-icon-file`
-   [Political scientists on Wikipedia](https://en.wikipedia.org/wiki/List_of_political_scientists) → `h2+ ul li > a:nth-child(1)`
...
-   **Cheat sheet for R scraping:** <https://cornelius-erfort.github.io/automated-web-data-collection-2026/cheatsheet/cheatsheet.html>
...
-   **Time:** 15-20 minutes
-   **Where in GitHub:** [`exercises/01-html.R`](exercises/01-html.R)
-   **Goal:** inspect webpage and extract elements with CSS selectors
-   **Steps:**
    1.  Open [`exercises/01-html.R`](exercises/01-html.R)
...
if (dir.exists("labour")) {
  unlink("labour", recursive = TRUE, force = TRUE)
}
```
...
-   **Time:** 20-25 minutes
-   **Where in GitHub:** [`exercises/02-webscraping.R`](exercises/02-webscraping.R)
-   **Goal:** scrape pages, store HTMLs, and combine info
-   **Steps:**
    1.  Open [`exercises/02-webscraping.R`](exercises/02-webscraping.R)
...
-   **Time:** 20-25 minutes
-   **Where in GitHub:** [`exercises/03-apis.R`](exercises/03-apis.R)
-   **Goal:** request API data, parse JSON, and transform nested output into rectangular data
-   **Steps:**
    1.  Open [`exercises/03-apis.R`](exercises/03-apis.R)
...
- Dynamic content (JavaScript-rendered pages): when `rvest` is not enough
- Browser automation with `rvest::read_html_live()` (headless Chrome via `chromote`)
- HTTP requests with `httr` (often faster than browser automation)
- Robust workflows: retries, logging, and scheduling
- Ethics and legal practice for responsible collection
